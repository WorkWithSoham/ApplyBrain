...
STOPWORDS = {
    ...
    "will", "have", "from", "our", "your", "we", "in", "to",
    "a", "an", "of", "is", "be", "as", "at", "by", "or", "on",
    "it", "its", "not", "but", "can", "all", "has", "was", "they"
}

# Tech keywords to specifically look for
TECH_KEYWORDS = {
    "python", "java", "javascript", "typescript", "react", "angular",
    "fastapi", "spring", "django", "node", "postgresql", "mysql",
    "mongodb", "redis", "docker", "kubernetes", "aws", "gcp", "azure",
    "llm", "ai", "ml", "rag", "vector", "chromadb", "kafka", "spark",
    "microservices", "rest", "api", "graphql", "ci/cd", "git",
    "agile", "scrum", "devops", "linux", "sql", "nosql",
}
...
def extract_keywords(text: str) -> set[str]:
    ...
    return {w for w in words
            ...
            and (w in TECH_KEYWORDS or len(w) > 5)}
...
ADVICE: [one specific thing to emphasize]"""
    ...
    try:
        async with httpx.AsyncClient(timeout=120) as client:
            r = await client.post(ROUTER_URL, json={
                "prompt":    prompt,
